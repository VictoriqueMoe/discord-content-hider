// ==UserScript==
// @name         Discord image blocker
// @namespace    victorique.moe
// @version      1.0.0
// @description  Hides message that contain an image you don't want to see
...
const AttachmentsManager_1 = __webpack_require__(901);
const UiBuilder_1 = __webpack_require__(245);
const LocalStoreManager_1 = __webpack_require__(227);
const Utils_1 = __webpack_require__(675);
let DiscordChatObserver = class DiscordChatObserver {
    constructor(_attachmentsManager, _uiBuilder, _localStoreManager) {
        this._attachmentsManager = _attachmentsManager;
        this._uiBuilder = _uiBuilder;
        this._localStoreManager = _localStoreManager;
        this.MAX_CONTENT_SIZE = 10485760; // 10MB
    ...
    async messageSent(mutationList, observer) {
    ...
    contextMenuCalled(mutationList, observer) {
        const contextMenu = mutationList[0].addedNodes[0];
        const mainGroup = contextMenu.querySelector(`[role="group"]:nth-child(2)`);
        if (!mainGroup) {
            return;
        }
    ...
    async init() {
        ...
        await pageInterceptor.pageChange(async () => {
            const chatContainer = await (0, Utils_1.waitForElm)('[data-list-id="chat-messages"]');
...
__decorate([
    (0, DiscordMessageEvent_1.DiscordMessageEvent)(DiscordMessageEvent_1.DiscordType.NEW_MESSAGE),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Array, MutationObserver]),
    __metadata("design:returntype", Promise)
], DiscordChatObserver.prototype, "messageSent", null);
__decorate([
    (0, DiscordMessageEvent_1.DiscordMessageEvent)(DiscordMessageEvent_1.DiscordType.ON_CONTEXT_MENU),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Array, MutationObserver]),
    __metadata("design:returntype", void 0)
], DiscordChatObserver.prototype, "contextMenuCalled", null);
__decorate([
...
DiscordChatObserver = __decorate([
    ...
    __metadata("design:paramtypes", [AttachmentsManager_1.AttachmentsManager,
        UiBuilder_1.UiBuilder,
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.DiscordMessageEvent = exports.DiscordType = void 0;
const tsyringe_1 = __webpack_require__(984);
const DiscordMutatorProxy_1 = __webpack_require__(728);
var DiscordType;
(function (DiscordType) {
    DiscordType[DiscordType["NEW_MESSAGE"] = 0] = "NEW_MESSAGE";
    DiscordType[DiscordType["ON_CONTEXT_MENU"] = 1] = "ON_CONTEXT_MENU";
})(DiscordType = exports.DiscordType || (exports.DiscordType = {}));
function DiscordMessageEvent(type) {
...
let DiscordMutatorProxy = class DiscordMutatorProxy {
    ...
    async onMessage() {
        const elm = await (0, Utils_1.waitForElm)('[data-list-id="chat-messages"]');
        this.observerProxy = new MutationObserver((mutations, observer) => {
            for (const observable of this.observerList.get(DiscordMessageEvent_1.DiscordType.NEW_MESSAGE)) {
                const instanceContext = tsyringe_1.container.resolve(observable.context);
    ...
    async onContextMenu() {
        const observer = new MutationObserver(mutations => {
            ...
            if (filteredMutations.length > 0) {
                for (const observable of this.observerList.get(DiscordMessageEvent_1.DiscordType.ON_CONTEXT_MENU)) {
                    const instanceContext = tsyringe_1.container.resolve(observable.context);
...
let UiBuilder = class UiBuilder {
    ...
    buildHideImageButton(contextMenu) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.AttachmentsManager = exports.AttachmentType = void 0;
const tsyringe_1 = __webpack_require__(984);
const UiBuilder_1 = __webpack_require__(245);
const md5 = __webpack_require__(568);
const GM_fetch = __webpack_require__(684);
var AttachmentType;
(function (AttachmentType) {
    AttachmentType[AttachmentType["IMAGE"] = 0] = "IMAGE";
    AttachmentType[AttachmentType["VIDEO"] = 1] = "VIDEO";
    AttachmentType[AttachmentType["BINARY"] = 2] = "BINARY";
})(AttachmentType = exports.AttachmentType || (exports.AttachmentType = {}));
let AttachmentsManager = class AttachmentsManager {
    constructor(_uiBuilder) {
        this._uiBuilder = _uiBuilder;
    }
    gatAttachmentsUrls(attachmentWrapper) {
    ...
    detectAttachmentType(messageAttach) {
    ...
    async getAttachmentFileSize(url) {
...
AttachmentsManager = __decorate([
    (0, tsyringe_1.singleton)(),
    __metadata("design:paramtypes", [UiBuilder_1.UiBuilder])
], AttachmentsManager);
